...
namespace ProjectTracker.Api.Services
{
    public interface ITaskService
    {
        ...
        Task<ProjectTask?> CreateAsync(int projectId, int? parentTaskId, string title, string? description, int? typeId, int tenantId);
        Task<ProjectTask?> UpdateAsync(int id, string title, string? description, bool isInvoiced, int? typeId, int tenantId);
